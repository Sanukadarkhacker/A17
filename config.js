...
// Auth information
global.pairNumber = "94741957521";                         // Add your paining number with country code example "916297175943"; 
...
// Owner information
global.Owner = process.env.OWNER ? process.env.OWNER.split(",") : ["940714774737"];
global.OwnerNumber = process.env.OWNER_NUMBER ? process.env.OWNER_NUMBER.split(",") : ["940714774737"];
global.ownertag = process.env.OWNER_TAG ? process.env.OWNER_TAG.split(",") : ["940714774737"];
global.OwnerName = process.env.OWNER_NAME || "Sanuka Geenith";
global.BotName = process.env.BOT_NAME || "Hermit - MD";
global.packname = process.env.PACK_NAME || "BY HERMIT - MD";
global.author = "By: Sanuka Geenith";
